...
export function MetopenCriteriaTable({
    ...
    return (
        <>
                                            ...
                                            <div className="flex items-center justify-between flex-wrap gap-2">
                                                ...
                                                <div className="flex items-center gap-2 flex-wrap">
                                                    <Button variant="outline" size="sm" className="h-7 text-xs"
                                                        onClick={(e) => { e.stopPropagation(); onAddCriteria(cpmk.id); }}>
                                                    ...
                                                    <div key={criteria.id} className="rounded-md border p-3 space-y-3">
                                                        <div className="flex items-center justify-between flex-wrap gap-2">
                                                            ...
                                                            <div className="flex items-center gap-1">
                                                                ...
                                                                <Button variant="ghost" size="icon" className="h-7 w-7 text-muted-foreground hover:text-destructive" title="Hapus kriteria"
                                                                            ...
                                                                            <TableRow key={rubric.id}>
                                                                                ...
                                                                                <TableCell className="text-right">
                                                                                    <div className="flex items-center justify-end gap-1">
                                                                                        ...
                                                                                        <Button variant="ghost" size="icon" className="h-7 w-7 text-muted-foreground hover:text-destructive" title="Hapus rubrik"
            ...
            <MetopenRubricItemFormDialog open={rubricFormOpen} onOpenChange={setRubricFormOpen}
            ...
            <AlertDialog open={!!deleteCriteriaId} onOpenChange={(open: boolean) => !open && setDeleteCriteriaId(null)}>
                <AlertDialogContent><AlertDialogHeader>
                    <AlertDialogTitle>Hapus Kriteria Metopel</AlertDialogTitle>
                    <AlertDialogDescription>Kriteria beserta seluruh rubrik di dalamnya akan dinonaktifkan. Kriteria yang sudah digunakan untuk penilaian tidak dapat dihapus.</AlertDialogDescription>
                </AlertDialogHeader><AlertDialogFooter>
                    <AlertDialogCancel>Batal</AlertDialogCancel>
                    <AlertDialogAction onClick={() => { if (deleteCriteriaId) { onDeleteCriteria(deleteCriteriaId); setDeleteCriteriaId(null); } }}
                        disabled={isDeletingCriteria} className="bg-destructive/70 text-destructive-foreground hover:bg-destructive/90">
            ...
            <AlertDialog open={!!deleteRubricId} onOpenChange={(open: boolean) => !open && setDeleteRubricId(null)}>
                <AlertDialogContent><AlertDialogHeader>
                    <AlertDialogTitle>Hapus Rubrik Metopel</AlertDialogTitle>
                    <AlertDialogDescription>Apakah Anda yakin ingin menghapus level rubrik ini?</AlertDialogDescription>
                </AlertDialogHeader><AlertDialogFooter>
                    <AlertDialogCancel>Batal</AlertDialogCancel>
                    <AlertDialogAction onClick={() => { if (deleteRubricId) { onDeleteRubric(deleteRubricId); setDeleteRubricId(null); } }}
                        disabled={isDeletingRubric} className="bg-destructive/70 text-destructive-foreground hover:bg-destructive/90">
