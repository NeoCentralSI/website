...
export function SlowStudentsCard({ students, isLoading, showViewAll = true }: SlowStudentsCardProps) {
            ...
            <CardContent className="max-h-80 overflow-y-auto">
                {displayStudents.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-6">
                        ...
                        />
                        <p className="text-sm text-muted-foreground mt-2">Tidak ada mahasiswa slow</p>
                    </div>
                ) : (
