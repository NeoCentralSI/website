...
import { useDefenceSchedulingData, useSetDefenceSchedule } from '@/hooks/thesis-defence';
...
export function ThesisDefenceDetailSchedulingPanel({ defenceId, isEditable }: Props) {
