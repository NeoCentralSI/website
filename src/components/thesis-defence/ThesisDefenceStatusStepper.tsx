...
const STEPS = [
  ...
  { key: 'scheduled', label: 'Penetapan Jadwal Sidang TA' },
  { key: 'defence', label: 'Pelaksanaan Sidang TA' },
] as const;
...
function getStepperTheme(status: ThesisDefenceStatus | null): StepperTheme {
...
export function ThesisDefenceStatusStepper({ status, allChecklistMet }: DefenceStatusStepperProps) {
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-card p-6">
      <h3 className="text-lg font-semibold mb-6">Status Sidang</h3>
