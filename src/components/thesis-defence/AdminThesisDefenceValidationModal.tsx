...
import { useAdminDefenceDetail, useValidateDefenceDocument } from '@/hooks/thesis-defence';
...
export function AdminThesisDefenceValidationModal({ defence, open, onOpenChange }: DefenceValidationModalProps) {
