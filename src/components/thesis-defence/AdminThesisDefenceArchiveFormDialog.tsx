...
export function AdminThesisDefenceArchiveFormDialog({
  open,
  onOpenChange,
  editingSeminar,
  thesisOptions,
  ...
  isPending,
  onSubmit,
}: AdminThesisDefenceArchiveFormDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[720px] max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{isEditing ? 'Edit Arsip Sidang TA' : 'Tambah Arsip Sidang TA'}</DialogTitle>
          <DialogDescription>
            Isi form berikut untuk mengelola data arsip sidang tugas akhir
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-2">
            ...
            {isEditing ? (
              ...
              <ComboBox
                ...
                items={thesisOptions.map((t) => ({
                  ...
                  disabled: Boolean(t.hasDefenceResult && t.defenceResultId !== editingSeminar?.id),
                }))}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={status}
                onValueChange={(value: Exclude<AdminDefenceArchiveStatus, 'cancelled'>) => setStatus(value)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
