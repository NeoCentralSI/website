...
import { AdminThesisDefenceVerificationFormDialog } from '@/components/thesis-defence/AdminThesisDefenceVerificationFormDialog';
...
interface AdminThesisDefenceVerificationTableProps {
...
export function AdminThesisDefenceVerificationTable({
  data,
  loading,
  isRefreshing,
  page,
  ...
  onDetail,
  actions,
}: AdminThesisDefenceVerificationTableProps) {
  ...
  return (
    <>
      ...
      <AdminThesisDefenceVerificationFormDialog
