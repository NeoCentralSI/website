...
interface AdminThesisSeminarFormDialogProps {
  open: boolean;
...
export function AdminThesisSeminarFormDialog({
  open,
  onOpenChange,
  editingSeminar,
  thesisOptions,
  ...
  isPending,
  onSubmit,
}: AdminThesisSeminarFormDialogProps) {
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="space-y-2">
              ...
              <Select value={status} onValueChange={(value: Exclude<AdminThesisSeminarArchiveStatus, 'cancelled'>) => setStatus(value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
