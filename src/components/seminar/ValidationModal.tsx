...
function getFileDownloadUrl(filePath: string | null) {
  if (!filePath) return null;
  // filePath is relative like "uploads/thesis/xxx/seminar/file.pdf"
  return `${ENV.API_BASE_URL}/${filePath}`;
}
...
export function ValidationModal({ seminar, open, onOpenChange }: ValidationModalProps) {
  ...
  const downloadUrl = currentDoc ? getFileDownloadUrl(currentDoc.filePath) : null;
