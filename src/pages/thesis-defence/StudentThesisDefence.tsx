...
import { useStudentDefenceOverview, useStudentDefenceHistory } from '@/hooks/thesis-defence';
import { ThesisDefenceStatusStepper } from '@/components/thesis-defence/ThesisDefenceStatusStepper';
import { StudentThesisDefenceInfoCard } from '@/components/thesis-defence/StudentThesisDefenceInfoCard';
import { ThesisEventStatusBadge } from '@/components/shared/ThesisEventStatusBadge';
import { StudentThesisDefenceChecklistRequirementsCard } from '@/components/thesis-defence/StudentThesisDefenceChecklistRequirementsCard';
import { StudentThesisDefenceDocumentCard } from '@/components/thesis-defence/StudentThesisDefenceDocumentCard';
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <StudentThesisDefenceChecklistRequirementsCard checklist={data.checklist} />
              <StudentThesisDefenceDocumentCard allChecklistMet={data.allChecklistMet} />
            </div>
          </div>
