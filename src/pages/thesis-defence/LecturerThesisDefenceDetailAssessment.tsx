import { LecturerThesisDefenceDetailLayout } from '@/components/thesis-defence/LecturerThesisDefenceDetailLayout';
...
export default function LecturerThesisDefenceDetailAssessment() {
  ...
  return (
    <LecturerThesisDefenceDetailLayout>
      {(detail) => {
        const canAccess =
