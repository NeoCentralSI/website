  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-base font-semibold tracking-tight sm:text-lg">Perbaikan Seminar</h1>
          <p className="text-xs text-muted-foreground sm:text-sm">Kelola perbaikan dari hasil seminar</p>
        </div>
      </div>
