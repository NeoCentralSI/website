...
import LecturerThesisSeminarDetailPage from './LecturerThesisSeminarDetail';
...
export default function LecturerThesisSeminarDetailOngoingPage() {
  ...
  if (!isOngoing || (!showExaminerTab && !showSupervisorTabs)) {
    return <LecturerThesisSeminarDetailPage />;
  }
