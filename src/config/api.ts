...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    CPMK: {
      ...
      COPY_TEMPLATE: '/cpmk/copy-template',
      HIERARCHY: '/cpmk/hierarchy',
    },
    SEMINAR_RUBRIC: {
      CPMKS: '/seminarRubric/cpmks',
      CRITERIA: '/seminarRubric/criteria',
      CRITERIA_BY_ID: (criteriaId: string) => `/seminarRubric/criteria/${criteriaId}`,
      CPMK_CONFIG: (cpmkId: string) => `/seminarRubric/cpmk/${cpmkId}`,
      CRITERIA_RUBRICS: (criteriaId: string) => `/seminarRubric/criteria/${criteriaId}/rubrics`,
      RUBRIC_BY_ID: (rubricId: string) => `/seminarRubric/rubrics/${rubricId}`,
      CRITERIA_REORDER: '/seminarRubric/criteria/reorder',
      RUBRICS_REORDER: '/seminarRubric/rubrics/reorder',
      WEIGHT_SUMMARY: '/seminarRubric/weight-summary',
    },
    DEFENCE_RUBRIC: {
      CPMKS: (role: string) => `/defenceRubric/cpmks?role=${role}`,
      CRITERIA: '/defenceRubric/criteria',
      CRITERIA_BY_ID: (criteriaId: string) => `/defenceRubric/criteria/${criteriaId}`,
      CPMK_CONFIG: (cpmkId: string, role: string) => `/defenceRubric/cpmk/${cpmkId}?role=${role}`,
      CRITERIA_RUBRICS: (criteriaId: string) => `/defenceRubric/criteria/${criteriaId}/rubrics`,
      RUBRIC_BY_ID: (rubricId: string) => `/defenceRubric/rubrics/${rubricId}`,
      CRITERIA_REORDER: '/defenceRubric/criteria/reorder',
      RUBRICS_REORDER: '/defenceRubric/rubrics/reorder',
      WEIGHT_SUMMARY: (role: string) => `/defenceRubric/weight-summary?role=${role}`,
    },
    EXIT_SURVEY: {
