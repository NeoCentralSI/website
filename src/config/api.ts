...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    RUBRIC_SEMINAR: {
      CPMKS: '/rubricSeminar/cpmks',
      CRITERIA: '/rubricSeminar/criteria',
      CRITERIA_BY_ID: (criteriaId: string) => `/rubricSeminar/criteria/${criteriaId}`,
      CPMK_CONFIG: (cpmkId: string) => `/rubricSeminar/cpmks/${cpmkId}/config`,
      CRITERIA_RUBRICS: (criteriaId: string) => `/rubricSeminar/criteria/${criteriaId}/rubrics`,
      RUBRIC_BY_ID: (rubricId: string) => `/rubricSeminar/rubrics/${rubricId}`,
      CRITERIA_TOGGLE: (criteriaId: string) => `/rubricSeminar/criteria/${criteriaId}/toggle`,
      CRITERIA_REORDER: '/rubricSeminar/criteria/reorder',
      RUBRICS_REORDER: '/rubricSeminar/rubrics/reorder',
      WEIGHT_SUMMARY: '/rubricSeminar/weight-summary',
    },
    RUBRIC_DEFENCE: {
      CPMKS: (role: string) => `/rubricDefence/cpmks?role=${role}`,
      CRITERIA: '/rubricDefence/criteria',
      CRITERIA_BY_ID: (criteriaId: string) => `/rubricDefence/criteria/${criteriaId}`,
      CPMK_CONFIG: (cpmkId: string, role: string) => `/rubricDefence/cpmks/${cpmkId}/config?role=${role}`,
      CRITERIA_RUBRICS: (criteriaId: string) => `/rubricDefence/criteria/${criteriaId}/rubrics`,
      RUBRIC_BY_ID: (rubricId: string) => `/rubricDefence/rubrics/${rubricId}`,
      CRITERIA_TOGGLE: (criteriaId: string) => `/rubricDefence/criteria/${criteriaId}/toggle`,
      CRITERIA_REORDER: '/rubricDefence/criteria/reorder',
      RUBRICS_REORDER: '/rubricDefence/rubrics/reorder',
      WEIGHT_SUMMARY: (role: string) => `/rubricDefence/weight-summary?role=${role}`,
    },
    EXIT_SURVEY: {
      BASE: '/exitSurvey',
