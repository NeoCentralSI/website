...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    INTERNSHIP_STUDENT: {
      ...
      PROPOSALS: '/internship/registration/proposals',
      RESPOND_INVITATION: (id: string) => `/internship/registration/proposals/${id}/respond`,
      COMPANIES: '/internship/registration/companies',
      ELIGIBLE_STUDENTS: '/internship/registration/eligible-students',
      SUBMIT_PROPOSAL: '/internship/registration/submit',
      SUBMIT_COMPANY_RESPONSE: (proposalId: string) => `/internship/registration/proposals/${proposalId}/company-response`,
      LOGBOOK: '/internship/activity/logbook',
      UPDATE_LOGBOOK: (id: string) => `/internship/activity/logbook/${id}`,
      UPDATE_DETAILS: '/internship/activity/update-details',
      ACTIVITY: '/internship/activity',
      REGISTER_SEMINAR: '/internship/activity/register-seminar',
      UPLOAD: '/documents/upload',
      VERIFY_FINAL_REPORT: (internshipId: string) => `/internship/activity/guidance/lecturer/students/${internshipId}/verify-report`,
    },
    INTERNSHIP_SEKDEP: {
      BASE: '/internship/sekdep',
      PROPOSALS: '/internship/sekdep/proposals',
      PROPOSAL_DETAIL: (id: string) => `/internship/sekdep/proposals/${id}`,
      COMPANY_STATS: '/internship/sekdep/companies/stats',
      COMPANIES: '/internship/sekdep/companies',
      COMPANY_DETAIL: (id: string) => `/internship/sekdep/companies/${id}`,
      COMPANY_RESPONSES: '/internship/sekdep/company-responses',
      VERIFY_COMPANY_RESPONSE: (id: string) => `/internship/sekdep/company-responses/${id}/verify`,
      INTERNSHIPS: '/internship/sekdep/internships',
      INTERNSHIPS_DETAIL: (id: string) => `/internship/sekdep/internships/${id}`,
      VERIFY_DOCUMENT: (id: string) => `/internship/sekdep/internships/${id}/verify-document`,
      VERIFY_DOCUMENTS_BULK: (id: string) => `/internship/sekdep/internships/${id}/verify-documents-bulk`,
      LECTURERS_WORKLOAD: '/internship/sekdep/lecturers/workload',
      LECTURERS_WORKLOAD_EXPORT: '/internship/sekdep/lecturers/workload/export',
      GUIDANCE_QUESTIONS: '/internship/sekdep/guidance/questions',
      GUIDANCE_QUESTION_DETAIL: (id: string) => `/internship/sekdep/guidance/questions/${id}`,
      GUIDANCE_CRITERIA: '/internship/sekdep/guidance/criteria',
      GUIDANCE_CRITERIA_DETAIL: (id: string) => `/internship/sekdep/guidance/criteria/${id}`,
    },
    INTERNSHIP_KADEP: {
    ...
    INTERNSHIP_ADMIN: {
      BASE: '/internship/admin',
      COMPANY_STATS: '/internship/admin/companies/stats',
      APPROVED_PROPOSALS: '/internship/admin/proposals/approved',
      APPROVED_PROPOSAL_DETAIL: (id: string) => `/internship/admin/proposals/${id}`,
      UPDATE_LETTER: (id: string) => `/internship/admin/proposals/${id}/letter`,
      ASSIGNMENT_PROPOSALS: '/internship/admin/assignment/proposals',
      ASSIGNMENT_PROPOSAL_DETAIL: (id: string) => `/internship/admin/assignment/proposals/${id}`,
      UPDATE_ASSIGNMENT_LETTER: (id: string) => `/internship/admin/assignment/proposals/${id}/letter`,
    },
