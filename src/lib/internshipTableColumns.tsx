import type { InternshipProposalItem, SekdepInternshipProposalItem, CompanyStatsItem, AdminApprovedProposalItem, InternshipPendingLetter } from '@/services/internship.service';
import type { Column } from '@/components/layout/CustomTable';
import { Badge } from '@/components/ui/badge';
import { Button } from '@/components/ui/button';
import { FileText, Eye, Check, X, Edit, Trash2, Signature } from 'lucide-react';
...
export const getKadepInternshipLetterColumns = ({
    ...
    onApprove,
        ...
        },
        {
            ...
            render: (item) => (
                <div className="flex items-center justify-center gap-1">
                    <span className="text-sm">{item.members.length + 1} Mahasiswa</span>
                </div>
            ),
            className: 'text-center',
        },
